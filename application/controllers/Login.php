...
class Login extends CI_Controller {
    ...
    public function auth()
    {
        ...
        // auth
        $proses_login = $this->db->query("SELECT * FROM tbl_login WHERE user='$user' AND pass = md5('$pass') AND status = 'Aktif'");
        ...
        if($row > 0)
        {
            ...
            echo '<script>alert("Login Gagal, Akun Belum aktif atau Periksa Kembali Username dan Password Anda");
